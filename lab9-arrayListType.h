...
public:
    ...
    virtual void insertFirst(int insertItem) = 0;
      //Function to insert insertItem at the start of the list.
      //Postcondition: List is shifted down by 1, insertItem is
      //               inserted at list[0], list must not be full.
    ...
    virtual void removeAll(int removeItem) = 0;
      //Function to remove all occurrences of removeItem.
      //Postcondition: If removeItem is found in the list,
      //               all occurrences of it are removed
      //               from the list.
